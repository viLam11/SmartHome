        ...
        <ScrollView className='mt-1 mx-2'>
            ...
            <View className='flex flex-row justify-between mt-2 mx-6'>   
                <View className="w-1/4 bg-enable p-1 rounded-lg">
                    <TouchableOpacity onPress={() => router.push(`/lights/1`)}>
                        <Text className='text-center font-semibold color-black'>Cài đặt</Text>
                    </TouchableOpacity>
                </View>
                <View className="w-1/4 bg-disable p-1 rounded-lg">
                    <TouchableOpacity onPress={() => router.push(`/hist/1`) }>
                        <Text className='text-center font-semibold color-slate-600'>Lịch sử</Text>
                    </TouchableOpacity>
                </View>
                <View className="w-1/4 bg-disable p-1 rounded-lg">
