    ...
    return (
        <SafeAreaView className="bg-white h-full">
            <ScrollView contentContainerClassName="h-full mx-2">
                ...
                <View className="flex flex-row items-center my-4">
                    <Text className="mx-2 text-gray-500">New here?</Text>
                    <Link href="/auth/register">
                        <TouchableOpacity className="bg-red-500 border border-gray-300 p-3 rounded-lg">
                            <Text className="ml-2 font-medium text-white">Register</Text>
                        </TouchableOpacity>
                    </Link>
                </View>
            </ScrollView>
